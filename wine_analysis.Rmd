...
```
France: m_topic_3 (soft, fruity flavor)
Italy: m_topic_6 (spicy, tannic flavor)
US: m_topic_5 (blend of different grapes variety)
...
To perform regression, we will first create a 80:20 training/testing split to validate our final model. 
```{r}
